...
public class GraphQLSchemaAssertions {
  ...
  public static class GraphQLSchemaAssertion {
    ...
    public GraphQLTypeAssertion withEnumType(String inputTypeName) {
      GraphQLTypeAssertion typeAssertion = withType(inputTypeName);
      assertThat(typeAssertion.typeDefinition)
          .as(String.format("Type '%s' should be an 'enum' type", inputTypeName))
          .isInstanceOf(EnumTypeDefinition.class);

      return typeAssertion;
    }


    public class GraphQLTypeAssertion {
      ...
      public GraphQLTypeAssertion withEnumValue(String expectedEnumValue) {
        EnumTypeDefinition enumTypeDefinition = (EnumTypeDefinition)typeDefinition;
        var def = enumTypeDefinition.getEnumValueDefinitions().stream().filter(e -> e.getName().equals(expectedEnumValue)).findAny();
        assertThat(def).as("Type should have an enum value '%s'".formatted(expectedEnumValue)).isPresent();
        return this;
      }

      public class GraphQLFieldAssertion {
        ...
        public GraphQLFieldAssertion withDescription() {
          ...
          assertThat(
            description != null && !description.getContent().isEmpty())
        ...
        public class GraphQLArgumentAssertion {
